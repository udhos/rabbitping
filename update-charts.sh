...
# the ./docs dir is published as https://udhos.github.io/rabbitping/

# generate chart package from source
helm package ./charts/rabbitping -d ./docs

# regenerate the index from existing chart packages
helm repo index ./docs --url https://udhos.github.io/rabbitping/
